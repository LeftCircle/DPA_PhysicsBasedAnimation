...
span<const Vector> DynamicalStateData::get_vector_attribute_span(const std::string& name) const {
	return _lookup_or_throw(_vec_attr, name, "vector").get_span();
}

span<const float> DynamicalStateData::get_float_attribute_span(const std::string& name) const {
	return _lookup_or_throw(_float_attr, name, "float").get_span();
}

span<const double> DynamicalStateData::get_double_attribute_span(const std::string& name) const {
	return _lookup_or_throw(_double_attr, name, "double").get_span();
}

span<const int> DynamicalStateData::get_int_attribute_span(const std::string& name) const {
	return _lookup_or_throw(_int_attr, name, "int").get_span();
}

span<const Color> DynamicalStateData::get_color_attribute_span(const std::string& name) const {
	return _lookup_or_throw(_color_attr, name, "color").get_span();
}

span<Vector> DynamicalStateData::get_vector_attribute_span(const std::string& name) {
	return _lookup_or_throw(_vec_attr, name, "vector").get_span();
}

span<float> DynamicalStateData::get_float_attribute_span(const std::string& name) {
	return _lookup_or_throw(_float_attr, name, "float").get_span();
}

span<double> DynamicalStateData::get_double_attribute_span(const std::string& name) {
	return _lookup_or_throw(_double_attr, name, "double").get_span();
}

span<int> DynamicalStateData::get_int_attribute_span(const std::string& name) {
	return _lookup_or_throw(_int_attr, name, "int").get_span();
}

span<Color> DynamicalStateData::get_color_attribute_span(const std::string& name) {
	return _lookup_or_throw(_color_attr, name, "color").get_span();
}
