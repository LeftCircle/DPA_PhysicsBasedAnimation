...
inline std::shared_ptr<BouncingBallThing> create_bouncing_ball_thing(const std::string& name = "BouncingBallThing"){
	return std::make_shared<BouncingBallThing>(name);
}
